...
import pint
from src.partitioning.partitioning import Partitioning
...
# ******* Modify the following lines according to your case *********************************************
# Location of the data files
listfiles   = glob("RawData30min/*.csv")
# Information about the measurement site and data
siteDetails = {"hi": 2.5 * ureg.meter, "zi": 4.0 * ureg.meter, "freq": 20 / ureg.second, "length": 30 / ureg.minute, "PreProcessing": True}
...
processing_args = {
    ...
    "steadyness": True,         # Compute statistic to check stationarity (will not delete data based on this)
    "saveprocessed": False,
}
